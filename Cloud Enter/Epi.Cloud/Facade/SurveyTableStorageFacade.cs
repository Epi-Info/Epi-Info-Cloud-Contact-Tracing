...
using Epi.Web.DataEntryServices;
...
namespace Epi.Web.MVC.Facade
{
    public class SurveyTableStorageFacade : ISurveyTableStorageFacade
    {
        ...
        public void InsertSurveyResponseToTableStorage(SurveyInfoModel surveyInfoModel, string responseId, Form form, SurveyAnswerDTO surveyAnswerDTO, bool IsSubmited, bool IsSaved, int PageNumber, int UserId)
        {
            ...
            bool response = _surveyResponse.Storeservey(_surveyResponseData);
        }
