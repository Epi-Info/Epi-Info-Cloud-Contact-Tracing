...
namespace Epi.Cloud.DataEntryServices
{
    public class DataService : IDataService
    {
		...
		public DataService(ISurveyInfoDao surveyInfoDao)
		{
        ...
        public SurveyInfoResponse GetSurveyInfo(SurveyInfoRequest pRequest)
        {
            try
            {
				...
				var surveyInfoBO = surveyInfoImplementation.GetSurveyInfoById(SurveyIdList);
                result.SurveyInfoList = Mapper.ToDataTransferObject(surveyInfoBO);
