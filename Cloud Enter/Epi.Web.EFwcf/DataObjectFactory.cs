...
namespace Epi.Web.EFwcf
{
    ...
    public static class DataObjectFactory
    {
        ...
        public static Epi.Web.EFwcf.OSELS_EWEEntities CreateContext()
        {
            return new Epi.Web.EFwcf.OSELS_EWEEntities(_connectionString);
        }
        public static Epi.Web.EFwcf.SurveyMetaData CreateSurveyMetaData()
        {
            return new Epi.Web.EFwcf.SurveyMetaData();
        }

        public static Epi.Web.EFwcf.SurveyResponse CreateSurveyResponse()
        {
            return new Epi.Web.EFwcf.SurveyResponse();
        }
