...
namespace MvcDynamicForms.Fields
{
    ...
    public class TimePicker : TimePickerField
    {
        ...
        public TimePicker(FieldAttributes fieldAttributes, double formWidth, double formHeight)
        {
