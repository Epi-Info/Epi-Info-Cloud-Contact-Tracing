...
namespace Epi.Data.Services
{
    public class MetadataDataSet : MetadataDbProvider
    {
        ...
        public MetadataDataSet(Project project) : base(project)
        {
        ...
        {
            return _dataSet.Tables["metaViews"].Copy();
        }
        ...
        public DataTable GetPagesForView(int viewId)
        {
            try
            {
                if (viewId < 1) throw new ArgumentOutOfRangeException("ViewId");

                string tableName = "metaPages";
                DataTable dataTable = _dataSet.Tables[tableName];

                IEnumerable<DataRow> query =
                    from dataRow in dataTable.AsEnumerable()
                    where dataRow.Field<int>("ViewId") == viewId
                    orderby dataRow.Field<Int16>("Position")
                    select dataRow;

                dataTable = _dataSet.Tables[tableName].Clone();
        ...
        public DataRow GetFieldIdByNameAsDataRow(string viewName, string fieldName)
        {
            ...
            IEnumerable<DataRow> joinRows =
                from view in _dataSet.Tables["metaViews"].AsEnumerable()
                join field in _dataSet.Tables["metaFields"].AsEnumerable()
                on view.Field<int?>("ViewId") equals field.Field<int?>("ViewId")
                where view.Field<string>("Name") == viewName && field.Field<string>("Name") == fieldName
                select field;

            DataTable returnTable = joinRows.CopyToDataTable();
        ...
        public View GetViewById(int viewId)
        {
            IEnumerable<DataRow> dataRows =
                from dataRow in _dataSet.Tables["metaViews"].AsEnumerable()
                where dataRow.Field<int?>("ViewId") == viewId
                select dataRow;
            DataTable returnTable = dataRows.CopyToDataTable();

            if (returnTable.Rows.Count > 0) return new View(returnTable.Rows[0], Project);
        ...
        {
            string tableName = "metaFields";
            DataTable dataTable = _dataSet.Tables[tableName];

            IEnumerable<DataRow> query =
                from dataRow in dataTable.AsEnumerable()
                where (dataRow.IsNull("ViewId") ? int.MinValue : dataRow.Field<int>("ViewId")) == view.Id
                orderby
                    (dataRow.IsNull("ControlTopPositionPercentage") ? double.MinValue : dataRow.Field<double>("ControlTopPositionPercentage")),
                    (dataRow.IsNull("ControlLeftPositionPercentage") ? double.MinValue : dataRow.Field<double>("ControlLeftPositionPercentage"))
                select dataRow;
        ...
        public DataTable GetFieldMetadataSync(View view)
        {
            try
            {
                ...
                DataTable returnTable =
                    (from dataRow in _dataSet.Tables[tableName].AsEnumerable()
                     where dataRow.Field<int?>("ViewId") == view.Id
                     select new
                     {
                         Name = dataRow.Field<string>(ColumnNames.NAME),
                         FieldTypeId = dataRow.Field<Int32>(ColumnNames.FIELD_TYPE_ID),
                         DataTableName = dataRow.Field<string>(ColumnNames.DATA_TABLE_NAME)
                     }
                    ).ToDataTable();
        ...
        public DataTable GetFieldMetadataSync(int pageId)
        {
            try
            {
                ...
                DataTable returnTable =
                    (from dataRow in _dataSet.Tables[tableName].AsEnumerable()
                     where (dataRow.IsNull("PageId") ? int.MinValue : dataRow.Field<int>("PageId")) == pageId
                     select new
                     {
                         Name = dataRow.Field<string>(ColumnNames.NAME),
                         FieldTypeId = dataRow.Field<Int32>(ColumnNames.FIELD_TYPE_ID),
        ...
        public View GetParentView(int viewId)
        {
            ...
            IEnumerable<DataRow> joinRows =
                from view in _dataSet.Tables["metaViews"].AsEnumerable()
                join field in _dataSet.Tables["metaFields"].AsEnumerable()
                on view.Field<int?>("ViewId") equals field.Field<int?>("RelatedViewId")
                where view.Field<int?>("ViewId") == viewId
                select field;
            ...
            if (returnTable.Rows.Count > 0)
            {
                RetVal = this.GetViewById((int)returnTable.Rows[0]["ViewId"]);
            }
        ...
        /// <summary>
        /// Get Text Fields For Page
        /// </summary>
        /// <param name="viewId">Id of View in Epi.Project.</param>
        /// <param name="pageId">Id of Page in Epi.View in Epi.Project.</param>
        /// <returns>Names and field ids of all text fields in a Page of an Epi.View.</returns>
        ...
        {
            if (string.IsNullOrEmpty(viewFullName)) throw new ArgumentNullException("View Full Name");

            string viewName = viewFullName.Substring(viewFullName.LastIndexOf(":") + 1);
            string tableName = "metaViews";

            IEnumerable<DataRow> dataRows =
                from dataRow in _dataSet.Tables[tableName].AsEnumerable()
                where dataRow.Field<string>("Name") == viewName
                select dataRow;
            DataTable returnTable = dataRows.CopyToDataTable();
        ...
        {
            if (viewId <= 0) throw new ArgumentException(SharedStrings.INVALID_VIEW_ID + ": \n" + viewId.ToString());

            DataTable returnTable =
                (from dataRow in _dataSet.Tables["metaFields"].AsEnumerable()
                 where dataRow.Field<int?>("ViewId") == viewId 
                    && !dataRow.IsNull(ColumnNames.DATA_TABLE_NAME) 
                    && (dataRow.Field<string>(ColumnNames.DATA_TABLE_NAME) != string.Empty)
                 select new
                 {
                     DataTableName = dataRow.Field<string>(ColumnNames.DATA_TABLE_NAME)
                 }).ToDataTable();
            
            if (returnTable.Rows.Count > 0) return returnTable.Rows[0][ColumnNames.DATA_TABLE_NAME].ToString();
        ...
        */
        ...
        public int CreateField(CheckBoxField field)
        {
            try
            {
                ...
                Query insertQuery = db.CreateQuery("insert into metaFields([DataTableName], [ViewId], [UniqueId], [CheckCodeAfter], [ControlFontFamily], [ControlFontStyle], [ControlFontSize], [ControlHeightPercentage], [ControlLeftPositionPercentage], [ControlTopPositionPercentage], [ControlWidthPercentage], [FieldTypeId], [HasTabStop], [IsReadOnly], [IsRequired], [Name], [PageId], [PromptFontFamily], [PromptFontStyle], [PromptFontSize], [PromptText], [ShouldRepeatLast], [TabIndex]) " +
		...
		*/
        ...
        public void AddGridColumn(DataRow gridColumnRow)
        {
            try
            {
                ...
                result = int.TryParse((string)gridColumnRow["Size"], out result) ? result : 0 ;
                insertQuery.Parameters.Add(new QueryParameter("@Size", DbType.Int32, result));
        ...
        public void CreateImagesTable()
        {
            ...
            columns.Add(new TableColumn("Image", GenericDbColumnType.Object, true));
        ...
        public void InsertCodeTableData(DataTable dataTable, string tableName, string[] columnNames)
        {
            ...
            try
            {
                ...
                for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                {
                    ...
                    for (int i = 0; i < columnNames.Length; i++)
                    {
                        insertQuery.Parameters.Add(new QueryParameter(StringLiterals.COMMERCIAL_AT + columnNames[i], DbType.String, row[columnNames[i]]));
                    }
        ...
        public void SaveCodeTableData(DataTable dataTable, string tableName, string[] columnNames)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < columnNames.Length; i++)
                {
                    insertQuery.Parameters.Add(new QueryParameter(StringLiterals.COMMERCIAL_AT + columnNames[i], DbType.String, columnNames[i], columnNames[i]));
                }
        ...
        public bool CreateCodeTable(string tableName, string[] columnNames)
        {
            ...
            try
            {
                ...
                if (db.TableExists(tableName.ToLower()))
                {
                    ...
                    createQuery = db.CreateQuery(sb.ToString());
        ...
        public void SynchronizePageNumbersOnInsert(View view, Page page)
        {
            try
            {
                ...
                Query query = db.CreateQuery("update metaPages set [Position] = [Position] + 1 where [ViewId] = @viewId and [Position] >= @position and [PageId] <> @pageId");
                query.Parameters.Add(new QueryParameter("@viewId", DbType.Int32, view.Id));
                query.Parameters.Add(new QueryParameter("@position", DbType.Int32, page.Position));
                query.Parameters.Add(new QueryParameter("@pageId", DbType.Int32, page.Id));
        ...
        public void UpdateField(DateTimeField field)
        {
            try
            {
                ...
                Query updateQuery = db.CreateQuery("update metaFields set [CheckCodeAfter] = @CheckCodeAfter, [CheckCodeBefore] = @CheckCodeBefore, " +
                    ...
                    "[Name] = @Name, [PageID] = @PageId, [Pattern] = @Pattern, [PromptFontFamily] = @PromptFontFamily, " +
        ...
        public void UpdateField(RelatedViewField field)
        {
            try
            {
                ...
                if (field.RelatedViewID <= 0)
                {
                    // May occur if the RelatedViewID column in metaFields is blank for this field
                    throw new ArgumentException("RelatedViewField.RelatedViewID");
                }
                #endregion

                Query updateQuery = db.CreateQuery("update metaFields set [RelateCondition] = @RelateCondition, [ControlFontFamily] = @ControlFontFamily, " +
                    "[ControlFontStyle] = @ControlFontStyle, [ControlFontSize] = @ControlFontSize, [ControlHeightPercentage] = @ControlHeightPercentage, " +
                    "[ControlLeftPositionPercentage] = @ControlLeftPositionPercentage, [ControlTopPositionPercentage] = @ControlTopPositionPercentage, " +
                    "[ControlWidthPercentage] = @ControlWidthPercentage, [FieldTypeId] = @FieldTypeId, [HasTabStop] = @HasTabStop, [Name] = @Name, " +
        ...
        {
            //Query selectQuery = db.CreateQuery("select MAX(TabIndex) from metaFields where PageId = @pageId and ViewId = @viewId and [FieldTypeId] not in (2,15,21,25) and @hasTabStop = [hasTabStop]");
            //selectQuery.Parameters.Add(new QueryParameter("@pageId", DbType.Int32, pageId));
            //selectQuery.Parameters.Add(new QueryParameter("@viewId", DbType.Int32, viewId));
            //selectQuery.Parameters.Add(new QueryParameter("@hasTabStop", DbType.Boolean, true));

            Query selectQuery = db.CreateQuery("select MAX(TabIndex) from metaFields where PageId = @pageId and ViewId = @viewId and IsReadOnly = @isReadOnly and [FieldTypeId] not in (2,21,25)");
            selectQuery.Parameters.Add(new QueryParameter("@pageId", DbType.Int32, pageId));
            selectQuery.Parameters.Add(new QueryParameter("@viewId", DbType.Int32, viewId));
            selectQuery.Parameters.Add(new QueryParameter("@isReadOnly", DbType.Boolean, includeReadOnly));
        ...
        {
            Query selectQuery = db.CreateQuery("select min(TabIndex) From metaFields where PageId = @pageId and ViewId = @viewId and TabIndex > @currentTabIndex and [FieldTypeId] not in (2,15,21) and @hasTabStop = [hasTabStop]");
        ...
        /// <summary>
        /// Verifies that the meta tables contain the current data
        /// </summary>
        private void VerifyPopulatedTables()
        {
            if (populatedTablesVerified)
            {
                return;
            }
            ...
            try
            {
                foreach (AppDataSet.DataTypesRow dataType in AppData.Instance.DataTypesDataTable.Rows)
                {
                    query = db.CreateQuery("SELECT 1 FROM metaDataTypes WHERE [DataTypeId] = @DataTypeId AND [Name] = @Name");
                    query.Parameters.Add(new QueryParameter("@DataTypeId", DbType.Int32, dataType.DataTypeId));
                    query.Parameters.Add(new QueryParameter("@Name", DbType.String, dataType.Name));
                ...
                foreach (AppDataSet.FieldTypesRow fieldType in AppData.Instance.FieldTypesDataTable.Rows)
                {
                    query = db.CreateQuery("SELECT 1 FROM metaFieldTypes WHERE [FieldTypeId] = @FieldTypeId AND [Name] = @Name");
                    query.Parameters.Add(new QueryParameter("@FieldTypeId", DbType.Int32, fieldType.FieldTypeId));
                    query.Parameters.Add(new QueryParameter("@Name", DbType.String, fieldType.Name));
                ...
                foreach (AppDataSet.DataPatternsRow pattern in AppData.Instance.DataPatternsDataTable.Rows)
                {
                    query = db.CreateQuery("SELECT 1 FROM metaPatterns WHERE [PatternId] = @PatternId AND [DataTypeId] = @DataTypeId");
                    query.Parameters.Add(new QueryParameter("@PatternId", DbType.Int32, pattern.PatternId));
                    query.Parameters.Add(new QueryParameter("@DataTypeId", DbType.Int32, pattern.DataTypeId));
                ...
                foreach (AppDataSet.LayerRenderTypesRow layerRenderType in AppData.Instance.LayerRenderTypesDataTable.Rows)
                {
                    query = db.CreateQuery("SELECT 1 FROM metaLayerRenderTypes WHERE [LayerRenderTypeId] = @LayerRenderTypeId AND [Name] = @Name");
                    query.Parameters.Add(new QueryParameter("@LayerRenderTypeId", DbType.Int32, layerRenderType.LayerRenderTypeId));
                    query.Parameters.Add(new QueryParameter("@Name", DbType.String, layerRenderType.Name));
        ...
        public DataTable GetDataDictionary(View view)
        {
            ...
            Query fieldsQuery = db.CreateQuery("SELECT " +
                "metaFields.PageId AS [Page Number], " +
        ...
        public DataRow GetPageSetupData(View view)
        {
            string tableName = "metaViews";
            DataTable dataTable = _dataSet.Tables[tableName];
            return dataTable.Select(string.Format("ViewId = {0}", view.Id))[0];
        }

        public Int32 InsertMetaImage(byte[] image)
        {
            Query insertQuery = db.CreateQuery
            (
            ...
            insertQuery.Parameters.Add(new QueryParameter("@Image", DbType.Object, image));
            insertQuery.Parameters.Add(new QueryParameter("@ImageUniqueValue", DbType.Int32, image.Length));
            db.ExecuteNonQuery(insertQuery);
        ...
        ///// <summary>
        ///// Delete Page Background Data
        ///// </summary>
        ///// <param name="page">page</param>
        //public void DeletePageBackgroundData(Page page)
        //{
        //    Query deleteQuery = db.CreateQuery("update [metaPages] set [BackgroundId]=@BackgroundId where [ViewId]=@ViewId and [PageId]=@PageId");

        //    //deleteQuery.Parameters.Add(new QueryParameter("@BackgroundId", DbType.Int32, page.view.ba)); 
        //    deleteQuery.Parameters.Add(new QueryParameter("@ViewId", DbType.Int32, page.view.Id));
        //    deleteQuery.Parameters.Add(new QueryParameter("@PageId", DbType.Int32, page.Id));

        //    int recordsAffected = db.ExecuteNonQuery(deleteQuery);
        //}
        #endregion
