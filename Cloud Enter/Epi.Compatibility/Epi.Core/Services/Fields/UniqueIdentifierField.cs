...
namespace Epi.Fields
{
	...
	/// Unique Key Field
	/// </summary>
	public class UniqueIdentifierField : PredefinedDataField, IMirrorable
	{
		#region Constructors
		...
		public UniqueIdentifierField(View view) : base(view)
		{
			Construct();
		}
        ...
        public UniqueIdentifierField(View view, XmlElement viewElement)
            : base(view)          
        {
        ...
        public UniqueIdentifierField(View view, XmlNode fieldNode)
            : base(view)
        {
		...
		{
			this.Name = ColumnNames.UNIQUE_IDENTIFIER;
