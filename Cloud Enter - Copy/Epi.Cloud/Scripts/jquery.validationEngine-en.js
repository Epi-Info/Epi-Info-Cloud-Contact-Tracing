        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "dateTimeRange": {
                 ...
                 "datePickerRange": {
                    "regex": "none",
                    "alertText": "Date must be in between"
                },
                "minSize": {
                    "regex": "none",
                    "alertText": "* Minimum ",
                ...
                "DD/MM/YYYY": {
                    "regex": /^(((((0[1-9])|(1\d)|(2[0-8]))\/((0[1-9])|(1[0-2])))|((31\/((0[13578])|(1[02])))|((29|30)\/((0[1,3-9])|(1[0-2])))))\/((20[0-9][0-9])|(19[0-9][0-9])))|((29\/02\/(19|20)(([02468][048])|([13579][26]))))$/,
                     
                    "alertText": "* Invalid date, must be in DD/MM/YYYY format"
                },
                "time": {
                 "regex": /^(\d{1,2}):(\d{2})(:(\d{2}))?(\s?(AM|am|PM|pm))?$/,
                 "alertText": "* Invalid time format"
                },
